  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>My initial pursuit of a career in the music industry led me to discovering the world of software engineering where I instantly found a love for creating striking, intuitive, and innovative user interfaces. I am motivated by my ambitious nature and a desire to explore my passions as well as continue my growth both professionally and personally.</p>
