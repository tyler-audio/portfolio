        ...
        <div id="tech_skills" className="row">
          ...
          <div className="row tech_lists">
            {Object.keys(techSkills).map((category) => (
              <div key={category}>
                <h5 className="tech_list_title">{category}</h5>
